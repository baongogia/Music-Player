...
import { AlbumType, SongType } from "../SpotifyInterfaces";
...
export default function AlbumPage() {
  ...
  useEffect(() => {
    ...
    fetch(`https://api.spotify.com/v1/albums/${id}`, authParam)
    ...
    <div className="absolute top-0 right-0 mt-[3em] ml-4 w-[84.15vw] min-h-[100vh] overflow-hidden bg-[#1d1f1f]">
      ...
      <div className="w-full h-[30vh] mt-28 ml-10 flex items-center">
        ...
        <div className="w-[65%] h-full ml-8 flex flex-col justify-between text-start">
          <div className="mt-10">
            <div className="text-[2em] font-bold leading-6 truncate">
            ...
            <div className="font-semibold text-[0.8em] ">
              Pop - {albumData?.release_date.slice(0, 4)} - Lossless
            </div>
        ...
        {/* Feature */}
        <div className="mt-[19.5%] w-[10%] flex items-center">
